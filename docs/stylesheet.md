...
- **Accent / primaire** : `#404134` (olive minéral). Défini dans `design-tokens.css` via `--primitive-green-800`.
  - **Pour changer la couleur primaire** : modifier uniquement `--primitive-green-800` dans `design-tokens.css`.
