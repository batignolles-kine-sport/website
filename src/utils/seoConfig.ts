...
export const BLOG_SEO_CONFIG: Record<string, BlogPostSEO> = {
  ...
  'periostite-tibiale-coureur': {
    ...
    title: 'Périostite Tibiale : Guide Complet du Coureur (2026)',
    metaDescription: 'Tibia en feu à chaque foulée ? Causes, traitement et reprise running en 4-8 sem. Évitez la fracture de stress. ✓ Kinés coureurs.',
    excerpt: 'Le tibia qui brûle au running ? Tout ce que vous devez savoir pour guérir et ne pas rechuter.',
    category: 'sport',
  ...
  'fracture-fatigue-coureur': {
    ...
    title: 'Fracture de Fatigue Coureur : 5 Signes d\'Alerte (2026)',
    metaDescription: 'Douleur osseuse qui empire à chaque sortie ? 5 signes d\'une fracture de stress. Ne pas ignorer ! ✓ Diagnostic + repos.',
    excerpt: 'Cette douleur au pied ou au tibia n\'est pas une courbature. Les signaux d\'alerte.',
    category: 'sport',
  ...
  'echauffement-course-pied': {
    ...
    title: 'Échauffement Course à Pied : Routine 8 Min (2026)',
    metaDescription: 'La routine d\'échauffement en 8 min qui prévient 80% des blessures running. Gammes + activation. ✓ Kinés du sport.',
    excerpt: 'Vous partez directement ? Voici les 8 minutes qui changent tout.',
    category: 'prevention',
  ...
  'preparation-physique-coureur': {
    ...
    title: 'PPG Coureur : 6 Exercices Indispensables (2026)',
    metaDescription: 'Préparation Physique Générale pour runners. 6 exercices clés pour courir plus vite et sans blessure. ✓ Programme téléchargeable.',
    excerpt: 'Les 6 exercices que tous les coureurs devraient faire. PPG pour progresser sans se blesser.',
    category: 'prevention',
  ...
  'recuperation-coureur': {
    ...
    title: 'Récupération Coureur : 7 Stratégies Prouvées (2026)',
    metaDescription: 'Optimisez votre récup post-running. 7 stratégies validées : sommeil, nutrition, mobilité. Progressez plus vite. ✓ Kinés sport.',
    excerpt: 'Vous vous entraînez beaucoup mais ne progressez plus ? Votre récupération est peut-être le problème.',
    category: 'prevention',
  ...
  'premier-marathon-preparation': {
    ...
    title: 'Premier Marathon : Guide Préparation Complète (2026)',
    metaDescription: 'Votre 1er marathon ? Plan d\'entraînement, nutrition, récupération. Évitez les 5 erreurs classiques. ✓ Guide kiné du sport.',
    excerpt: 'Prêt pour les 42 km ? Le guide complet pour franchir la ligne sans casser.',
    category: 'sport',
  ...
  'lombalgie-sportif': {
    ...
    title: 'Lombalgie Sportif : 5 Exercices Efficaces (2026)',
    metaDescription: 'Dos bloqué qui gêne l\'entraînement ? 5 exercices pour sportifs + adaptation charge. Continuez à progresser. ✓ Kinés sport.',
    excerpt: 'Le bas du dos qui coince à chaque séance ? Le protocole pour sportifs lombalgiques.',
    category: 'sport',
  ...
  'lombalgie-teletravail-routine': {
    ...
    title: 'Lombalgie Télétravail : Routine 10 Min (2026)',
    metaDescription: 'Bureau à la maison = dos en vrac ? Routine 10 min quotidienne + ergonomie. Soulagez vos lombaires. ✓ Kinés posture Paris.',
    excerpt: 'Le télétravail détruit votre dos ? La routine quotidienne qui change tout.',
    category: 'prevention',
  ...
  'douleur-inter-scapulaire-teletravail': {
    ...
    title: 'Douleur Entre les Omoplates : 5 Solutions (2026)',
    metaDescription: 'Cette barre entre les omoplates après l\'écran ? 5 exercices + réglages bureau. Soulagement rapide. ✓ Kinés posture.',
    excerpt: 'La douleur entre les omoplates qui brûle après 2h de bureau. Les solutions.',
    category: 'prevention',
  ...
  'tendinite-de-quervain-teletravail': {
    ...
    title: 'Tendinite de Quervain : Traitement et Prévention (2026)',
    metaDescription: 'Pouce et poignet qui brûlent à la souris ? Tendinite de Quervain. Traitement + ergonomie. ✓ Kinés main Paris.',
    excerpt: 'Le pouce qui tire à chaque clic ? La tendinite de Quervain des travailleurs sur écran.',
    category: 'prevention',
